...
public sealed class _BaiscObjectPool : MonoBehaviour
{
	private static _BaiscObjectPool _instance;
	...
	public static _BaiscObjectPool instance
	{
		get
		{
			if (_instance != null)
			...
			_instance = obj.AddComponent<_BaiscObjectPool>();
			return _instance;
		}
	}
}

public static class _BasicObjectPoolExtensions
{
	public static void CreatePool<T>(this T prefab) where T : Component
	{
		_BaiscObjectPool.CreatePool(prefab);
	}
	
	public static T Spawn<T>(this T prefab, Vector3 position, Quaternion rotation) where T : Component
	{
		return _BaiscObjectPool.Spawn(prefab, position, rotation);
	}
	public static T Spawn<T>(this T prefab, Vector3 position) where T : Component
	{
		return _BaiscObjectPool.Spawn(prefab, position, Quaternion.identity);
	}
	public static T Spawn<T>(this T prefab) where T : Component
	{
		return _BaiscObjectPool.Spawn(prefab, Vector3.zero, Quaternion.identity);
	}
	
	public static void Recycle<T>(this T obj) where T : Component
	{
		_BaiscObjectPool.Recycle(obj);
	}

	public static int Count<T>(T prefab) where T : Component
	{
		return _BaiscObjectPool.Count(prefab);
	}
}
